...
function Mr(r) {
    ...
    return {
        c() {
            //e = E("div"), e.innerHTML = '<h1 class="text-3xl font-bold text-gray-800 sm:text-4xl dark:text-white">Welcome to <span class="nav-title">Vanna.AI</span></h1> <p class="mt-3 text-gray-600 dark:text-gray-400">Your AI-powered copilot for SQL queries.</p>', v(e, "class", "max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto text-center")
            e = E("div"), e.innerHTML = '<img class="w-125 h-auto" src="header.png" alt="GenAI4SAP Header"/>'//, v(e, "class", "max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto text-center")
        },
        m(n, t) {
            U(n, e, t)
        },
...
function zr(r) {
    ...
    return {
        c() {
            e = E("div"), n = E("input"), t = Z(), o = E("div"), i = E("div"), s = E("div"), s.innerHTML = "", l = Z(), c = E("div"), a = E("button"), a.innerHTML = '<svg class="h-3.5 w-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="M15.964.686a.5.5 0 0 0-.65-.65L.767 5.855H.766l-.452.18a.5.5 0 0 0-.082.887l.41.26.001.002 4.995 3.178 3.178 4.995.002.002.26.41a.5.5 0 0 0 .886-.083l6-15Zm-1.833 1.89L6.637 10.07l-.215-.338a.5.5 0 0 0-.154-.154l-.338-.215 7.494-7.494 1.178-.471-.47 1.178Z"></path></svg>', v(n, "type", "text"), v(n, "class", "p-4 pb-12 block w-full bg-gray-100 border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-800 dark:border-gray-700 dark:text-gray-400"), v(n, "placeholder", "Faça uma pergunta sobre seus dados para que eu possa transformar em SQL"), v(s, "class", "flex items-center"), v(a, "type", "button"), v(a, "class", "inline-flex flex-shrink-0 justify-center items-center h-8 w-8 rounded-md text-white bg-blue-600 hover:bg-blue-500 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"), v(c, "class", "flex items-center gap-x-1"), v(i, "class", "flex justify-between items-center"), v(o, "class", "absolute bottom-px inset-x-px p-2 rounded-b-md bg-gray-100 dark:bg-slate-800"), v(e, "class", "relative")
        },
        m(k, x) {
...
function Jr(r) {
    ...
    return {
        c() {
            e = E("li"), n = E("img"), o = Z(), i = E("div"), c && c.c(), or(n.src, t = "assistant.png") || v(n, "src", t), v(n, "class", "flex-shrink-0 w-[2.375rem] h-[2.375rem] "), v(n, "alt", "agent logo"), v(i, "class", "space-y-3 overflow-x-auto overflow-y-hidden"), v(e, "class", "max-w-4xl py-2 px-4 sm:px-6 lg:px-8 mx-auto flex gap-x-2 sm:gap-x-4")
        },
        m(a, d) {
...
function eo(r) {
    ...
    return s = new pt({
        ...
        c() {
            e = E("li"), n = E("img"), o = Z(), i = E("div"), J(s.$$.fragment), or(n.src, t = "assistant.png") || v(n, "src", t), v(n, "class", "flex-shrink-0 w-[2.375rem] h-[2.375rem] animate-bounce "), v(n, "alt", "agent logo"), v(i, "class", "space-y-3"), v(e, "class", "max-w-4xl py-2 px-4 sm:px-6 lg:px-8 mx-auto flex gap-x-2 sm:gap-x-4")
        },
        m(c, a) {
...
function Io(r) {
    ...
    return {
        c() {
            e = we("Os resultados estão corretos?")
        },
        m(n, t) {
            U(n, e, t)
        },
...
function oi(r) {
    ...
    return {
        c() {
            var j;
            e = E("div"), n = E("div"), t = E("div"), o = E("div"), i = E("h2"), i.textContent = "Adicionar dados de treinamento", s = Z(), l = E("button"), l.innerHTML = '<span class="sr-only">Close</span> <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.258206 1.00652C0.351976 0.912791 0.479126 0.860131 0.611706 0.860131C0.744296 0.860131 0.871447 0.912791 0.965207 1.00652L3.61171 3.65302L6.25822 1.00652C6.30432 0.958771 6.35952 0.920671 6.42052 0.894471C6.48152 0.868271 6.54712 0.854471 6.61352 0.853901C6.67992 0.853321 6.74572 0.865971 6.80722 0.891111C6.86862 0.916251 6.92442 0.953381 6.97142 1.00032C7.01832 1.04727 7.05552 1.1031 7.08062 1.16454C7.10572 1.22599 7.11842 1.29183 7.11782 1.35822C7.11722 1.42461 7.10342 1.49022 7.07722 1.55122C7.05102 1.61222 7.01292 1.6674 6.96522 1.71352L4.31871 4.36002L6.96522 7.00648C7.05632 7.10078 7.10672 7.22708 7.10552 7.35818C7.10442 7.48928 7.05182 7.61468 6.95912 7.70738C6.86642 7.80018 6.74102 7.85268 6.60992 7.85388C6.47882 7.85498 6.35252 7.80458 6.25822 7.71348L3.61171 5.06702L0.965207 7.71348C0.870907 7.80458 0.744606 7.85498 0.613506 7.85388C0.482406 7.85268 0.357007 7.80018 0.264297 7.70738C0.171597 7.61468 0.119017 7.48928 0.117877 7.35818C0.116737 7.22708 0.167126 7.10078 0.258206 7.00648L2.90471 4.36002L0.258206 1.71352C0.164476 1.61976 0.111816 1.4926 0.111816 1.36002C0.111816 1.22744 0.164476 1.10028 0.258206 1.00652Z" fill="currentColor"></path></svg>', c = Z(), a = E("span"), a.textContent = "Tipo de dado de treinamento", d = Z(), g = E("div");
...
function ii(r, e, n) {
    let {
        ...
        name: "DDL",
        description: "Estas são as instruções CREATE TABLE que definem a estrutura do seu banco de dados.",
        example: "CREATE TABLE table_name (column_1 datatype, column_2 datatype, column_3 datatype);"
    }, {
        name: "Documentação",
        description: "Pode ser qualquer documentação baseada em texto. Mantenha os pedaços pequenos e focados em um único tópico.",
        example: "Nossa definição de ABC é XYZ."
    }, {
        name: "SQL",
        description: "Pode ser qualquer instrução SQL que funcione. Quanto mais melhor.",
...
function nr(r) {
    ...
    return e = new ri({
        props: {
            message: "Tem certeza de que deseja excluir isto?",
            buttonLabel: "Deletar",
            onClose: r[19],
            onConfirm: r[20]
        }
...
function fi(r) {
    ...
    return {
        c() {
            Te && Te.c(), e = Z(), n = E("div"), t = E("div"), o = E("div"), i = E("div"), s = E("div"), l = E("div"), c = E("div"), c.innerHTML = '<h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">Dados de Treinamento</h2> <p class="text-sm text-gray-600 dark:text-gray-400">Adicione ou remova dados de treinamento. Bons dados de treinamento são a chave para a precisão.</p>', a = Z(), d = E("div"), g = E("div"), k = E("button"), k.textContent = "Ver todos", x = Z(), D = E("button"), D.innerHTML = `<svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2.63452 7.50001L13.6345 7.5M8.13452 13V2" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path></svg>
                    Adicionar dados de treinamento`, L = Z(), m = E("table"), h = E("thead"), p = E("tr");
            for (let X = 0; X < Pe.length; X += 1) Pe[X].c();
            _ = Z(), A = E("tbody");
            for (let X = 0; X < Oe.length; X += 1) Oe[X].c();
            P = Z(), T = E("div"), u = E("div"), f = E("p"), f.textContent = "Mostrando:", O = Z(), C = E("div"), S = E("span"), R = we(j), q = we(" - "), N = we(B), ie = Z(), re = E("p"), re.textContent = `of ${r[7].length}`, Ye = Z(), Ae = E("div"), De = E("div"), Ve = E("button"), Ve.innerHTML = `<svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"></path></svg>
                    Anterior`, lt = Z(), me = E("button"), me.innerHTML = `Próximo
